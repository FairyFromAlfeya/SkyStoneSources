...
@Autonomous(name = "RedSkyStoneFoundation", group = "Red")
//@Disabled
public class RedSkyStoneFoundation extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (position) {
            case RIGHT:
                chassis.encoderDrive(0.5, 400, Chassis.Direction.FORWARD, 2.5);
                break;
            case CENTER:
                chassis.encoderDrive(0.5, 200, Chassis.Direction.FORWARD, 2);
        }

        grabber.grabRed();

        chassis.encoderDrive(0.5, 100, Chassis.Direction.RIGHT, 1.5);
        chassis.distanceDrive(0.5, Chassis.Direction.FORWARD, 50, 2);
        chassis.encoderDrive(0.5, 200, Chassis.Direction.LEFT, 2);

        grabber.throwBlockRed();
